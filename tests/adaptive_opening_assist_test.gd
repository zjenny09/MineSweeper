...
func _run_tests() -> void:
	...
	for level_index in 2:
		...
		_expect(
			...
			"Levels 1 and 2 can arm safe-first assistance."
		)
		var early_streaks := {}
		...
		_expect(
			...
			"Levels 1 and 2 can arm region-opening assistance."
		)
	...
	_expect(
		board.opening_assist_mode == MinesweeperBoard.OpeningAssist.SAFE_FIRST,
		"Three consecutive first-reveal losses arm safe-first assistance."
	)
